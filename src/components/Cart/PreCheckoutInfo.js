...
export default function PreCheckoutInfo() {
    ...
    return (
        <>
            ...
            <CheckoutButton styles="py-2 w-1/3 bg-cyan-400 text-white font-semibold tracking-wide rounded-lg mt-5 transition transform duration-200 hover:-translate-y-1 active:-translate-y-1 active:ring-2 active:ring-offset-2 active:ring-cyan-400" />
        </>
    )
}
